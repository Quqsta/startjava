public class VariableNamesTheme {
    public static void main(String[] args) {
        ...
        // окончание диапазона
        String endOfRange = "на предельном значении";
        ...
        // размер
        float value = 75f;
        System.out.println("размер - " + value + " м куб.");

        // вместимость
        int capacity = 22;
        System.out.println("вместимость - " + capacity + " галлона");

        // счетчик
        float count = 22.8f;
        System.out.println("счетчик - " + count + " т.");

        // путь до файла
        String filePath = "C:\\JavaProgramming\\Sample.java";
